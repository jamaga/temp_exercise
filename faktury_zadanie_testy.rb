...
class InvoicesAppClientTest < Test::Unit::TestCase
  ...
  def test_products_description
    ...
    c = InvoicesApp::Product.new(products_decsription, Faker::Number.digit, Faker::Commerce.price)
    assert_equal c.description, products_decsription
  end

  def test_product_quantity
    products_quantity = Faker::Number.digit
    c = InvoicesApp::Product.new(Faker::Hacker.say_something_smart, products_quantity, Faker::Commerce.price)
